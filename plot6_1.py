...
ax1 = axs[0]
ax1.set(xlim = (0, 20), ylim = (-1, 1), xticks = np.arange(0, 20), yticks = np.arange(-1, 1, 0.2))
...
ax2 = axs[1]
ax2.set(xlim = (0, 1), ylim = (-0.1, 0.1), xticks = np.arange(0, 1, 0.1), yticks = np.arange(-0.1, 0.1, 0.02))
